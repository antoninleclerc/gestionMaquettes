		...
		public:
			...
			*/
			...
			/**	
	 		 ...
	 		 */
			void enregistrerUE(const std::string &mention);
		private:
			/**
	    	* 	Entier représentant l'ECTS
	    	*/
			int d_ECTS;
			/**
	    	* 	Vector d'ECUE (La premiere case du vecteur est toujours l'UE principale, tout ce qui suit est les ECUE de cet UE.)
	    	*/
			std::vector <ECUE*> d_UE;
	};
